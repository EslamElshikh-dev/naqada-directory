...
const sections = [
  { href: '/knowledge/places', title: 'خريطة المكان', count: knowledgePlaces.length, text: 'قرى ونجوع وعزب وحواجر وعلاقات تبعية وأسماء تاريخية، مع فصل البيانات التاريخية عن الوضع المعاصر.', image: '/images/landmarks/naqada-city.webp', alt: 'مشهد من مدينة نقادة' },
  { href: '/knowledge/people', title: 'أعلام نقادة', count: knowledgePeople.length, text: 'شخصيات وردت في المصدر، مصنفة بوسوم المجال والمكان دون اختلاق صلات عائلية غير مثبتة.', image: '/images/categories/community.webp', alt: 'مشهد مجتمعي يعبر عن أهل نقادة' },
  { href: '/knowledge/heritage', title: 'التراث والمعالم', count: knowledgeHeritage.length, text: 'آثار وتراث ومواقع وموضوعات سياحية وحرفية جاهزة للتوسع التحريري المنسوب للمصدر.', image: '/images/landmarks/naqada-royal-tomb.webp', alt: 'المقبرة الملكية في نقادة' },
