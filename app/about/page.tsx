  ...
  return (
    <main id="main-content" className="page-main">
      ...
      <section className="shell about-layout">
        ...
        <article className="prose-card" id="updates"><span className="eyebrow eyebrow--dark">التحديث والتصحيح</span><h2>كيف يُراجع السجل؟</h2><p>أي تصحيح ينبغي أن يحدد اسم السجل، المعلومة المطلوب تعديلها، ومصدرًا عامًا مباشرًا يدعم التعديل. لا تُقبل صلات النسب أو التبعيات المكانية المبنية على الاستنتاج وحده.</p><p>أصبحت هناك صفحة مساهمة مخصصة لتجهيز طلب إضافة نشاط أو تصحيح سجل أو الإبلاغ عن نتيجة بحث مفقودة بشكل منظم قبل المراجعة.</p><Link className="button button--primary" href="/contribute">أضف نشاطًا أو صحح بيانات</Link></article>
      </section>
    </main>
  );
}
