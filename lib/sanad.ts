...
const faq: { match: RegExp; text: string; cards: SanadCard[] }[] = [
  ...
  { match: /تحديثات الموقع|اخر التحديثات|ايه الجديد|ايه اتغير/, text: 'اتضافت صفحة الوظائف للفرص والخبرات، وصفحات مستقلة للنماذج المشرفة، وتحسّن البحث الموحد ومسارات القرى والأنشطة، وكمان جرس التنبيهات بقى يجيب ما نُشر فعلًا. صفحة التحديثات تعرض سجلات الأنشطة حسب تاريخ مراجعتها؛ ولو تقصد أخبار نقادة وقنا فدي صفحة منفصلة مع مصدر كل خبر.', cards: [link('سجل تحديثات الأنشطة', '/updates'), link('الوظائف', '/jobs'), link('النماذج المشرفة', '/role-models'), link('الأخبار بمصادرها', '/news')] },
