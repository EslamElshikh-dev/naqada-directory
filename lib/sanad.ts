...
const faq: { match: RegExp; text: string; cards: SanadCard[] }[] = [
  ...
  { match: /^(مين انت|اسمك ايه|تقدر تعمل ايه|بتعمل ايه|مساعده|ساعدني|اسئله|كل الاسئله)[؟!\s]*$/, text: 'أنا سند، مساعدك في دليل نقادة. أسندك في الوصول للخدمات والأنشطة والأرقام والعناوين المتاحة، والقرى والنجوع، والمعالم والتراث والأعلام والعائلات، وكمان استخدام الدليل وإضافة نشاط. قولّي بتدور على إيه وفي أي قرية؟ إجاباتي من محتوى الدليل، وأوضح لك لما المعلومة مش متاحة.', cards: [link('الخدمات والأنشطة', '/activities'), link('موسوعة نقادة', '/knowledge')] },
