    ...
    <footer className={footerStyles.footer}>
      ...
      <div className={`shell ${footerStyles.shell}`}>
        ...
        <div className={footerStyles.bottom}>
          ...
          <a href="https://eslam-elshikh.com/" target="_blank" rel="noreferrer" className={footerStyles.signature}><span>تصميم وتطوير</span><b>المهندس إسلام الشيخ</b><span aria-hidden="true">↗</span></a>
        </div>
      </div>
    </footer>
  );
