...
type Review = { id: string; rating: number; body: string; authorName: string; authorBio: string; avatarUrl: string | null; createdAt: string; updatedAt: string; own: boolean; frameCode: MemberFrameCode; roleLabel: string };
